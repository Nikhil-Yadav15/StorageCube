...
export const getFileIcon = (
  ...
  switch (extension) {
    ...
    case "xls":
    case "xlsx": return "/assets/icons/file-document.svg";
    case "svg": return "/assets/icons/file-image.svg";
    case "mkv":
    case "mov":
    case "avi":
    case "wmv":
    ...
    case "webm":
    case "m4v":
    case "3gp": return "/assets/icons/file-video.svg";
    case "mp3":
    case "mpeg":
    case "wav":
    case "aac":
    ...
    case "m4a":
    case "aiff":
    case "alac": return "/assets/icons/file-audio.svg";
    default:
      switch (type) {
        case "image": return "/assets/icons/file-image.svg";
        case "document": return "/assets/icons/file-document.svg";
        case "video": return "/assets/icons/file-video.svg";
        case "audio": return "/assets/icons/file-audio.svg";
        default: return "/assets/icons/file-other.svg";
      }
  }
};

export const getUsageSummary = (totalSpace: TotalSpaceType) => {
  return [
    {
      title: "Documents",
...
const sliceFileName = (name: string) => {
  ...
  if (width < 300) return name.slice(0, 10) + "...";
  if (width < 400) return name.slice(0, 15) + "...";
  if (width < 600) return name.slice(0, 30) + "...";
  if (width < 900) return name.slice(0, 50) + "...";
  return name;
};
